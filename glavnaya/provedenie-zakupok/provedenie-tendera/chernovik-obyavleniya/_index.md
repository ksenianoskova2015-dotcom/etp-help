...
-  скачивания генерируемого документа объявления по закупке до подписания

   -  Пример документа [Объявление (7).pdf](<Объявление (7).pdf>)
...
![](./chernovik-obyavleniya-7.png){width=770px height=810px}
...
-  На странице отображается страница статуса «Объявления готовые к публикации» - статус объявления переходит в [«Готово к публикации»](./../podpisanie-v-publikaciyu-status-gotovo-k-publik)

-  После нажатия на кнопку «Готово к публикации» окно объявления закрывается.

![](./chernovik-obyavleniya-8.png){width=1628px height=742px}
...
### Не вложен документ в разделе Прилагаемые документы заказчика

Объявление нельзя отправить на публикацию, если не вложен ни один документ в разделе `Прилагаемые документы Заказчика`